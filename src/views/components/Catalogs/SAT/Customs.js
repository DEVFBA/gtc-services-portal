...
function Customs({dataTable, updateAddData, ip, autoCloseAlert}) {
  ...
  const [dataState, setDataState] = React.useState(
    ...
    <ModalUpdateCustoms abierto = {modalUpdateRecord} toggleModalUpdateRecord = {toggleModalUpdateRecord} record = {record} updateAddData = {updateAddData} ip = {ip} autoCloseAlert={autoCloseAlert}/>
