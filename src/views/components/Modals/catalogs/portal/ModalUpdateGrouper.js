...
function ModalUpdateGrouper({abierto, toggleModalUpdateRecord, record, updateAddData, ip, autoCloseAlert}) {
        // update form
    ...
    function updateRegister(){
        ...
        fetch(`${process.env.REACT_APP_API_URI}cat-catalogs/update-portal-grouper`, {
            method: "PUT",
...
export default ModalUpdateGrouper;