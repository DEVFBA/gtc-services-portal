...
function ModalUpdateRelationshipTypes({abierto, toggleModalUpdateRecord, record, updateAddData, ip, autoCloseAlert}) {
        // update form
    ...
    function updateRegister(){
        ...
        const catRegister = {
            pSpCatalog: "spSAT_Cat_Relationship_Types_CRUD_Records",
            pvOptionCRUD: "U",
            pvIdCatalog: id,
...
export default ModalUpdateRelationshipTypes;