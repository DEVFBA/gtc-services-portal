...
function ModalAddCustoms({modalAddRecord, setModalAddRecord, updateTable, setUpdateTable, updateAddData, ip, autoCloseAlert}) {
        // update form
    ...
    return (
        ...
        <h5 className="modal-title">Agregar Registros</h5>
        </div>
        <ModalBody>
...
export default ModalAddCustoms;