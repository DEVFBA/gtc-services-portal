...
function ModalUpdateReasonsTransfer({abierto, toggleModalUpdateRecord, record, updateAddData, ip, autoCloseAlert}) {
        // update form
    ...
    function updateRegister(){
        ...
        const catRegister = {
            pSpCatalog: "spSAT_Cat_Shipping_Reasons_CRUD_Records",
            pvOptionCRUD: "U",
            pvIdCatalog: id,
...
export default ModalUpdateReasonsTransfer;