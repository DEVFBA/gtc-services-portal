...
function ModalUpdateIncoterm({abierto, toggleModalUpdateRecord, record, updateAddData, ip, autoCloseAlert}) {
        // update form
    ...
    function updateRegister(){
        ...
        const catRegister = {
            pSpCatalog: "spSAT_Cat_Incoterms_CRUD_Records",
            pvOptionCRUD: "U",
            pvIdCatalog: id,
...
export default ModalUpdateIncoterm;