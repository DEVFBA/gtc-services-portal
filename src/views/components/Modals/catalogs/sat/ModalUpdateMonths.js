...
function ModalUpdateMonths({abierto, toggleModalUpdateRecord, record, updateAddData, ip, autoCloseAlert}) {
        // update form
    ...
    function updateRegister(){
        ...
        const catRegister = {
            pSpCatalog: "spSAT_Cat_Months_CRUD_Records",
            pvOptionCRUD: "U",
            pvIdCatalog: id,
...
export default ModalUpdateMonths;