...
function ModalUpdateFrequency({abierto, toggleModalUpdateRecord, record, updateAddData, ip, autoCloseAlert}) {
        // update form
    ...
    function updateRegister(){
        ...
        const catRegister = {
            pSpCatalog: "spSAT_Cat_Frequency_CRUD_Records",
            pvOptionCRUD: "U",
            pvIdCatalog: id,
...
export default ModalUpdateFrequency;