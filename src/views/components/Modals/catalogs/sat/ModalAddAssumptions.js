...
function ModalAddAssumptions({modalAddRecord, setModalAddRecord, updateAddData, ip, autoCloseAlert}) {
    ...
    const isValidated = () => {
        if (
          ...
          return true;
            ...
            if (firstRowState !== "has-success") {
                setFirstRowState("has-danger");
            }
            return false;
        }
    };
    ...
    function addRegister(){
        ...
        fetch(`http://localhost:9000/api/cat-catalogs/create-sat-assumptions`, {
            method: "POST",
...
export default ModalAddAssumptions;