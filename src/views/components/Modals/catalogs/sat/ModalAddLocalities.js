...
function ModalAddLocalities({modalAddRecord, setModalAddRecord, updateAddData, ip, autoCloseAlert, dataCountries, dataStates}) {
    ...
    function addRegister(){
        ...
        fetch(`${process.env.REACT_APP_API_URI}cat-catalogs/create-sat-locations`, {
            method: "POST",
...
export default ModalAddLocalities;