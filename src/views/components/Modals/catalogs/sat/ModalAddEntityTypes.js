...
function ModalAddEntityTypes({modalAddRecord, setModalAddRecord, updateAddData, ip, autoCloseAlert}) {
    ...
    const isValidated = () => {
        if (
          ...
          return true;
            ...
            if (taxIdLengthState !== "has-success") {
    ...
    function addRegister(){
        ...
        fetch(`${process.env.REACT_APP_API_URI}cat-catalogs/create-sat-entity-type`, {
            method: "POST",
...
export default ModalAddEntityTypes;