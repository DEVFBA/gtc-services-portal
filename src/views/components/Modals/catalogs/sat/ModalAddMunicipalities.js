...
function ModalAddMunicipalities({modalAddRecord, setModalAddRecord, updateAddData, ip, autoCloseAlert, dataCountries, dataStates}) {
    ...
    const isValidated = () => {
        if (
          ...
          return true;
            ...
            if (estadoState !== "has-success") {
                setEstadoState("has-danger");
            }
            return false;
        }
    };
    ...
    function addRegister(){
        ...
        fetch(`${process.env.REACT_APP_API_URI}cat-catalogs/create-sat-municipalities`, {
            method: "POST",
...
export default ModalAddMunicipalities;