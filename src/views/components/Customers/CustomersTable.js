...
function CustomersTable({dataTable, dataCountries, updateAddData, pathLogo, ip, profilePath, autoCloseAlert, dataTaxRegimes}){
    ...
    return (
        <>
            ...
            <ModalUpdateClient modalUpdateRecord = {modalUpdateRecord} setModalUpdateRecord = {setModalUpdateRecord} record = {record} dataCountries = {dataCountries} updateAddData = {updateAddData} pathLogo = {pathLogo} ip = {ip} profilePath = {profilePath} autoCloseAlert = {autoCloseAlert} dataTaxRegimes = {dataTaxRegimes}/>
        </>
    );
}
